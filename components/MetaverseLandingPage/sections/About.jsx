    ...
    <section className={`${styles.paddings} relative z-10`}>
      ...
      >
        ...
        <motion.p
          ...
          className='mt-[8px] font-normal sm:text-[32px] text-[20px] text-center dark:text-secondary-white'
        >
          ...
          into reality. Let's <span className='font-extrabold'>explore</span>{' '}
          the madness of the metaverse by scrolling down
        </motion.p>

        <motion.img
          variants={fadeIn('up', 'tween', 0.3, 1)}
          src='/metaverse/arrow-down.svg'
          alt='arrow down'
          className='w-[44px] h-[44px] p-2 dark:bg-transparent bg-black rounded-full object-contain mt-[28px]'
        ></motion.img>
      </motion.div>
    </section>
  )
